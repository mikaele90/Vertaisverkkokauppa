...
INSERT INTO `verkkokauppa`.`itemdb` (`ItemId`, `ItemName`, `ItemCategory`, `ItemPrice`, `ItemDescription`, `ItemSubCategory`, `Availability`) VALUES ('3', 'Testituote4', 'Testituottet2', '1.25', 'Tämä on neljäs testituote', 'Testituotteet2 alikategoria', '1');
INSERT INTO `verkkokauppa`.`itemdb` (`ItemId`, `ItemName`, `ItemCategory`, `ItemPrice`, `ItemDescription`, `ItemSubCategory`, `Availability`) VALUES ('3', 'Testituote5', 'Testituottet', '5.45', 'Tämä on viides testituote', 'Testituotteet alikategoria', '1');
INSERT INTO `verkkokauppa`.`itemdb` (`ItemId`, `ItemName`, `ItemCategory`, `ItemPrice`, `ItemDescription`, `ItemSubCategory`, `Availability`) VALUES ('3', 'Testituote6', 'Testituottet', '3.32', 'Tämä on kuudes testituote', 'Testituotteet alikategoria', '1');